...
config.bosh = 'https://jitsi.toluolatubosun.com/' + subdir + 'http-bind';
config.websocket = 'wss://jitsi.toluolatubosun.com/' + subdir + 'xmpp-websocket';
...
// Default logo
config.defaultLogoUrl = 'https://toluolatubosun.com/images/logo.png';
// Default language.
...
config.whiteboard = {
    ...
    enabled: true,
    collabServerBaseUrl: 'https://whiteboard.toluolatubosun.com',
    userLimit: 25,
